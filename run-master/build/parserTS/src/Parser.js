...
var Parser = /** @class */ (function () {
     ...
     * ;
     */
    Parser.prototype.StatementList = function (stopLookahead) {
        if (stopLookahead === void 0) { stopLookahead = null; }
        var statementList = [this.Statement()];
    ...
    Parser.prototype.BlockStatement = function () {
        ...
        if (this._lookahead != null) {
            ...
            var blockEnd = this._eat("}");
            var tmp = {
                type: "BlockStatement",
                body: body,
                loc: {
                    start: __assign({}, body[0].loc.start),
                    end: __assign({}, body[body.length - 1].loc.end)
                },
    ...
    Parser.prototype._BinaryExpression = function (builderName, operatorToken) {
        var left = this.exp[builderName]();
        while (this._lookahead.type === operatorToken) {
            // operator: *, /
            var operator = this._eat(operatorToken).value;
            var right = this.exp[builderName]();
            left = {
     ...
     *
     */
    Parser.prototype.AssignmentExpressionx = function () {
        var expression = this.Expression();
        this._eat("=");
        return {
            type: "AssignmentExpression",
